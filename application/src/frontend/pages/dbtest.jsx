...
const Dbtest = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://http://ec2-3-139-83-222.us-east-2.compute.amazonaws.com/api/dbtest")
      .then((response) => {
    ...
    axios
      .get("http://http://ec2-3-139-83-222.us-east-2.compute.amazonaws.com/api/searchtest") //dummy url to get data from backend mysql
      .then((response) => {
